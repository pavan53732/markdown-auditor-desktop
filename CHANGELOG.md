...
- **Proof-Aware Severity Gating**: `model_only` findings in `api_contract` and `specification_formalism` are now capped at medium severity so unsupported formal-contract claims cannot overstate risk ahead of deterministic proof support.
