...
- Further-decomposed runtime orchestration: `auditOrchestrator.js`, `pipelineController.js`, `resultAggregator.js`, `executionStateController.js`, `agentMeshRuntime.js`, `sessionService.js`, and `workbenchController.js` now own most non-UI pipeline logic instead of keeping that flow in one React component
